...
runGrowthModel_Nimble <- function(d,mcmcInfo,code,speciesGr,nB){
  ...
  constants <- list(riverDATA = d$riverDATA,
                    ...
                    evalRows = d$evalRows,
                    lastObsRows = d$lastObsRows,
                    nLastObsRows = d$nLastObsRows,
                    nMoreThanOneInterval = d$nMoreThanOneInterval,
                    moreThanOneInterval = d$moreThanOneInterval,
                    nExactlyOneInterval = d$nExactlyOneInterval,
                    exactlyOneInterval = d$exactlyOneInterval,
                    nSeasons = d$nSeasons,
