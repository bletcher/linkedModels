...
q$betaGG <- factor(q$beta, levels = 1:10, labels = c("Temp", "Flow", "Temp*Flow","Temp^2","Flow^2","Length","BKT","BNT","BNT*BKT","ATS"), ordered = T)
...
ggsave('figures/grBetaSigmas.png', height = 7, width = 10, scale = 2)
